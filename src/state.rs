...
impl DocumentService {
    pub fn new(db: DocumentDb, directories: HashMap<String, String>) -> Self {
        Self {
            db,
    ...
    pub async fn read_file(&self, id: &str) -> Result<DocumentData, LedgeknawError> {
    ...
    pub async fn get_chunk_config(&self, id: uuid::Uuid) {}
}
